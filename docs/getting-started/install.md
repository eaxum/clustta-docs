...
- **The web dashboard** - At [app.clustta.com](https://app.clustta.com). Used for managing your account, studios and collaborators.
...
After signing in for the first time, you'll land in your **Personal studio** - your private workspace. Every Clustta user has one. Projects here stay local unless you choose to sync them to ClusttaCloud™.
