...
// Lucide SVG icon helper (16x16, stroke-based)
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Website', link: 'https://clustta.com' },
    ],
    ...
    sidebar: [
      {
        text: 'Welcome',
        items: [
          { text: icon(icons.bookOpen, 'Introduction'), link: '/guide/introduction' },
          { text: icon(icons.rocket, 'Getting Started'), link: '/guide/getting-started' },
        ],
      },
      {
        text: 'Core Concepts',
        items: [
          { text: icon(icons.folderOpen, 'Projects'), link: '/guide/projects' },
          { text: icon(icons.settings, 'Project Settings'), link: '/guide/project-settings' },
          { text: icon(icons.layers, 'Assets & Collections'), link: '/guide/assets-and-collections' },
          { text: icon(icons.layoutGrid, 'The Browser'), link: '/guide/the-browser' },
        ],
      },
      {
        text: 'Features',
        items: [
          { text: icon(icons.fileCheck, 'File States, Statuses & Checkpoints'), link: '/guide/file-states-task-statuses-and-checkpoints' },
          { text: icon(icons.image, 'Statuses, Checkpoints & Thumbnails'), link: '/guide/statuses-checkpoints-and-thumbnails' },
          { text: icon(icons.gitBranch, 'Assignations, Dependencies & Syncing'), link: '/guide/assignations-dependencies-and-syncing' },
          { text: icon(icons.search, 'Search & Filter'), link: '/guide/search-and-filter' },
        ],
      },
      {
        text: 'Reference',
        items: [
          { text: icon(icons.keyboard, 'Keyboard Shortcuts'), link: '/guide/keymap' },
          { text: icon(icons.palette, 'Artist Workflow'), link: '/guide/artist-workflow' },
          { text: icon(icons.box, 'Architecture'), link: '/guide/clustta-architecture' },
          { text: icon(icons.helpCircle, 'FAQ'), link: '/guide/frequently-asked-questions' },
        ],
      },
    ],
