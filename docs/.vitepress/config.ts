...
function icon(svg: string, label: string): string {
  return `<span class="sidebar-icon">${svg}</span>${label}`
}

// Lucide icons as inline SVGs (from lucide.dev, 24x24 viewBox, 2px stroke)
const icons = {
  // Welcome
  ...
  folderPlus: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 10v6"/><path d="M9 13h6"/><path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2a2 2 0 0 0-1.66-.9H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/></svg>',
  ...
  // Features – Core
  gitCommit: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><line x1="3" x2="9" y1="12" y2="12"/><line x1="15" x2="21" y1="12" y2="12"/></svg>',
  ...
  share: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" x2="12" y1="2" y2="15"/></svg>',
  ...
  // Features – Integrations and Plugins
  ...
  circleGauge: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="20" y2="10"/><line x1="18" x2="18" y1="20" y2="4"/><line x1="6" x2="6" y1="20" y2="16"/></svg>',
}

export default defineConfig({
  title: 'Clustta',
  description: 'Open-source version control, collaboration and asset management for creative work',

  head: [
    ['link', { rel: 'icon', type: 'image/x-icon', href: '/clustta.ico' }],
    ['link', { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/clustta.png' }],
    ['link', { rel: 'apple-touch-icon', href: '/clustta.png' }],
    ['meta', { name: 'theme-color', content: '#773baf' }],
    ['meta', { name: 'apple-mobile-web-app-status-bar-style', content: 'black' }],
  ],

  // Output to dist at root
  outDir: '../dist',

  // Resolve image/icon paths from public directory so <img src="/images/..."> works
  vite: {
    resolve: {
      alias: {
  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          { text: icon(icons.download, 'Install'), link: '/getting-started/install' },
          { text: icon(icons.folderPlus, 'Your First Project'), link: '/getting-started/first-project' },
          { text: icon(icons.users, 'Studios & Collaboration'), link: '/getting-started/studios' },
          { text: icon(icons.server, 'Self-Hosting'), link: '/getting-started/self-hosting' },
        ],
      },
      {
        text: 'Core Features',
        items: [
          { text: icon(icons.layers, 'Assets & Collections'), link: '/features/collections-and-assets' },
          { text: icon(icons.copy, 'Asset Templates'), link: '/features/asset-templates' },
          { text: icon(icons.gitCommit, 'Checkpoints & Versioning'), link: '/features/checkpoints' },
          { text: icon(icons.workflow, 'Workflows'), link: '/features/workflows' },
          { text: icon(icons.gitBranch, 'Dependencies'), link: '/features/dependencies' },
        ],
      },
      {
        text: 'Collaboration',
        items: [
          { text: icon(icons.userCheck, 'Assignments & Statuses'), link: '/features/assignments-and-statuses' },
          { text: icon(icons.refreshCw, 'Sync & Conflicts'), link: '/features/sync-and-conflicts' },
          { text: icon(icons.shield, 'Roles & Permissions'), link: '/features/roles-and-permissions' },
          { text: icon(icons.share, 'Sharing'), link: '/features/sharing' },
        ],
      },
      {
        text: 'Project Management',
        items: [
          { text: icon(icons.trash, 'Trash & Recovery'), link: '/features/trash' },
          { text: icon(icons.eyeOff, 'Ignore Patterns'), link: '/features/ignore-patterns' },
          { text: icon(icons.search, 'Search'), link: '/features/search' },
        ],
      },
      {
        text: 'Integrations and Plugins',
        items: [
          { text: icon(icons.plug, 'Overview'), link: '/features/integrations' },
          { text: icon(icons.refreshCw, 'Kitsu'), link: '/features/kitsu-integration' },
          { text: icon(icons.plug, 'DCC Bridge'), link: '/features/dcc-bridge' },
      ...
      },
      {
        text: 'Architecture',
        items: [
          { text: icon(icons.box, 'Overview'), link: '/architecture/overview' },
          { text: icon(icons.database, 'Storage & Versioning'), link: '/architecture/storage' },
          { text: icon(icons.refreshCw, 'Sync Model'), link: '/architecture/sync' },
          { text: icon(icons.shieldCheck, 'Security'), link: '/architecture/security' },
        ],
      },
      {
        text: 'Reference',
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/eaxum/clustta-client' },
      { icon: 'discord', link: 'https://discord.gg/NuR4uAuTZd' },
    ],
    ...
    footer: {
      message: 'Built with love for creative professionals.',
      copyright: '© 2024-present Clustta',
    },

    editLink: {
      pattern: 'https://github.com/eaxum/clustta-docs/edit/main/docs/:path',
